...
function Header() {
  return (
    <header className="absolute flex justify-center bg-gray-900 bg-opacity-90 w-full min-w-full">
      <div className="grid grid-cols-2 p-2 items-center flex-grow max-w-7xl">
        <a href="/" className="place-self-center">
          <img
        ...
        <nav className="relative place-self-center grid grid-cols-3 text-center items-center">
          <div id="hover-dropdown" className="group whitespace-nowrap">
            <a
              href="#services"
              className="text-sm sm:text-md lg:text-xl text-gray-300 inline sm:m-1 px-1.5 rounded-lg hover:bg-gray-800 hover:bg-opacity-50 cursor-pointer"
            >
              Services &darr;
            </a>
            <Dropdown></Dropdown>
          ...
          <a
            href="#about"
            className="text-sm md:text-md lg:text-xl text-gray-300 inline sm:m-1 px-1.5 rounded-lg hover:bg-gray-800 hover:bg-opacity-50 cursor-pointer"
          >
            About
          </a>
          <a
